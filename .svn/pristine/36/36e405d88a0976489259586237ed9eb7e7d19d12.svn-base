                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <a href="#">
                                ...
                                <div>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque eleifend${pageContext.request.contextPath}/admin2.</div>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                    ...
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
                            <div class="input-group custom-search-form">
                                <input type="text" class="form-control" placeholder="Search${pageContext.request.contextPath}/admin2.">
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/"><i class="fa fa-table fa-fw"></i> Tables</a>
                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/form"><i class="fa fa-edit fa-fw"></i> Forms</a>
                        </li>
                        <li>
