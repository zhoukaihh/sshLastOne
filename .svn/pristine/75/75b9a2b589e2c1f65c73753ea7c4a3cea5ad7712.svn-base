...
<%@ page import="com.qfedu.SSHDemo.dto.MenuDto" %>
<%
...
<title>用户管理</title>
    ...
    <!-- DataTables CSS -->
    <link href="${pageContext.request.contextPath}/admin2/vendor/datatables-plugins/dataTables.bootstrap.css" rel="stylesheet">

    <!-- DataTables Responsive CSS -->
    <link href="${pageContext.request.contextPath}/admin2/vendor/datatables-responsive/dataTables.responsive.css" rel="stylesheet">
...
<body>
                    ...
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
                            <div class="input-group custom-search-form">
                                <input type="text" class="form-control input-sm" placeholder="Search/admin2.">
                        ...
                        <% for (MenuDto m : menus) { %>
                        <li>
                            <a href="#" class="<%=m.getActiveCls()%>"><i class="fa <%=m.getIcon()%> fa-fw"></i> <%=m.getName()%><span class="fa arrow"></span></a>
                            <% if (m.getChildren().size() > 0) { %>
                            <ul class="nav nav-second-level">
                            	<% for (MenuDto c : m.getChildren()) { %>
                                <li>
                                    <a href="#" menuURL="<%=c.getUrl()%>" class="<%=c.getActiveCls()%>"><i class="fa <%=c.getIcon()%> fa-fw"></i> <%=c.getName()%></a>
                                </li>
                                <% } %>
                            </ul>
                            <% } %>
    ...
    <script src="${pageContext.request.contextPath}/admin2/vendor/datatables/js/jquery.dataTables.min.js"></script>
    <script src="${pageContext.request.contextPath}/admin2/vendor/datatables-plugins/dataTables.bootstrap.min.js"></script>
    <script src="${pageContext.request.contextPath}/admin2/vendor/datatables-responsive/dataTables.responsive.js"></script>
