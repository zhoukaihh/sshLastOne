<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
            ...
            var selectedPosition = {
            	ids : $('#deptFormPositionIds').val(),
            	names : $('#deptFormPositionNames').val()
            };
            ...
            $(document).ready(function() {
                ...
                var table = $('#' + tableId).DataTable({
                    ...
                    "rowId" : 'id',
                    "ajax": {
                        "url": "${pageContext.request.contextPath}/dept/position/list",
                        "type": "GET"
                    },
                    "order": [[ 0, "asc" ]] ,
                    "columns": [
            ...
            function selectPositionOK () {
            	...
            	$('#deptFormPositionIds').val (selectedPosition.ids);
            	$('#deptFormPositionNames').val (selectedPosition.names);
            	$('#page-wrapper').remove();
